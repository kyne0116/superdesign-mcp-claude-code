...
function detectPlatform() {
    ...
    if (forcePlatform && Object.values(Platform).includes(forcePlatform)) {
...
function createConfig() {
    ...
    return {
        ...
        logLevel: getEnvValue('LOG_LEVEL', 'info') || LogLevel.INFO,
 ...
 */
export function getSuperdeignDirectoryPath(workspacePath) {
 ...
 */
export function getDesignIterationsPath(workspacePath) {
 ...
 */
export function getDesignSystemPath(workspacePath) {
    const superdesignDir = getSuperdeignDirectoryPath(workspacePath);
